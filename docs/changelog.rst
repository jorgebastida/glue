...
* This version includes **several** backward incompatible changes - **read this document carefully before upgrading**.
  ...
  - Glue will **not** extract padding information from filenames. If you want to customize paddings individually (per image), you should use `configuration files <http://glue.readthedocs.org/en/latest/files.html>`_.
